	...
	<body>
		...
		%>
      	...
      	<!-- Header -->
				...
				<header id="header" class="alt" style="background-color: #ffd9e9; font-family: 'Jua', sans-serif;">    <!--메뉴상단 배경색깔-->
				...
				<!-- Menu -->
					<nav id="menu" style="font-family: 'Jua', sans-serif;">
						<ul class="links">
							...
							<li><a href="../i_community/community.html">모임찾기</a></li>
        ...
        <!-- Product section-->
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5" font-family: 'Jua', sans-serif;>
                <div class="row gx-4 gx-lg-5 align-items-center" style="margin-top: 110px">
                    <div class="col-md-6">
                    
                    
                    <!-- #####이미지 출력 부분-->
                    <img style="    width: 100%;"  class="meetphoto" src="../upload/<%=mtvo.getMeetPhoto()%>" alt="..." /></div>
                    ...
                    <div class="col-md-6">
                    	...
                    	<!-- ######모임지역 -->
                        <div class="small mb-1" font-family: 'Jua', sans-serif;><%=mtvo.getMeetLocation()%></div>
                        
                        
                        <!-- ####모임 이름 -->
                        <h1  style="margin: 10px;" class="display-5 fw-bolder" font-family: 'Jua', sans-serif;><%=mtvo.getMeetName()%></h1>
                        
                        
                        
                        <!-- ####모임 설명 부분 -->
                        <table border="1">
                        <p  class="lead" font-family: 'Jua', sans-serif;><%=mtvo.getMeetContent()%></p>
                        
                        
                        </table>
                        
                        <div  style="margin-top: 20px;" class="d-flex" font-family: 'Jua', sans-serif;>
        ...
        <h3 class="con"><게시글 목록> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
       <a href="boardwrite.jsp?seq=<%=seq%>" style="    border: 0.5px solid black;
												    padding: 10px;
												    border-radius: 10px;
												    font-size: 20px;"  >글 작성하러 가기</a></h3>
        <br>
