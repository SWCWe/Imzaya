...
<title>Insert title here</title>
  ...
  <%  ArrayList<MeetVO> list = (ArrayList<MeetVO>)request.getAttribute("meetfindlist"); 
		...
		<!-- Wrapper -->
			<div id="wrapper">
				...
				<!--콘텐츠 부분 시작-->
				  ...
				  <!-- Navigation-->
				  <nav class="수정"  style="margin-top: 1em; font-size: 25px;">
					<div class="container px-4 px-lg-5">
						<a class="navbar-brand" href="#!"  >처음으로 가기</a>
				</nav>
				<!-- Header-->
				...
				<div class="container1" style="display: flex; justify-content: center;">
					<button class="button" style="border-radius: 10px;">
						...
						<button class="button" style="border-radius: 10px;">
							...
							<a href="find_filter.html">지역 / 관심사</a>
