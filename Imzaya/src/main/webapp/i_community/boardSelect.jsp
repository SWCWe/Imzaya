...
<div style="margin-top: 2%; font-family: 'Jua', sans-serif; ">
    ...
    <section class="article-detail table-common con row" style="margin: auto; height: 365px; ">
       
        
        <table class="cell" border="1">
            <colgroup>
                <col width="100px" height="700px">
            </colgroup>
            <tbody>
                ...
                <tr class="article-info">
                    <th>날짜</th>
                 <br>   <td>일시 : <%=bvo.getArticleDate() %></td>
                    
                    <td>작성자 : <%=bvo.getmId() %></td>
                </tr>
                <tr class="article-body">
                 <th>내용</th>
                    <td colspan="4" style="font-size: 20px; line-height: 40px;" > <br> 
...
<div class="con reply" font-family: 'Jua', sans-serif;>
    <h1 class="" style="font-size: 25px;"  >댓글 입력</h1>
    <section class="reply-form">
        ...
        <form action="ComWriteCon.do">
           ...
           <div style="display:flex;  flex-direction: row-reverse;  ">  
			...
			style="font-size: 25px; font-size: 20px; width: 16.5%;
    ...
    <h1 class="" style="font-size: 25px;" >댓글 목록</h1>
    <br>
    <section class="reply-list table-common">
        <table border="1">
			...
			<tr>
				...
				<td style=" font-size: 17px; " > <%=clist.get(i).getCmtDate() %> </td>
