...
<body class="is-preload">
	...
	<header id="header1">
		<div class="inner" style="text-align: center;">
			...
			<form action="ProfileLocationCon.do">
				<!-- 여기 주소 바꿔야 됨-->
				<table>
					<tr style="background-color: white; color: black;">
						<td colspan="3">새로운 지역을 선택하세요.</td>

					</tr>
					<tr style="background-color: gainsboro; color: black;">
						<td colspan="3"><select name="location" style="color: black">
					...
					<tr style="background-color: gainsboro; color: black;">
						<td colspan="3"><input type="submit" id="profileTable"></input></td>
					</tr>
