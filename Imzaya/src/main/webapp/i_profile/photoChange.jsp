...
<body class="is-preload">
	...
	<header id="header1">
		<div class="inner" style="text-align: center;">
			<br>
			<!-- <a href="#" class="image avatar" style="height: 200px; width: 200px;"><img src="../images/고양이 사진.jpg" alt="" style="height: 200px; width: 200px;"></a> -->
			...
			<form action="ProfilePhotoUpdateCon.do" enctype="multipart/form-data"
				method="post" style="margin-bottom: 1000px">
				<table>
					<tr style="background-color: white; color: black;">
						<td colspan="3">새로운 이미지를 찾으세요.</td>

					</tr>
					<tr style="background-color: white; color: black;">
						<td colspan="3">
							<div>
								<input type="file" style="background-color: rgb(215, 215, 215);"
									id="profileTable" name="chooseFile" accept="image/*" />
							</div>
						</td>
					</tr>
					...
					<tr style="background-color: white; color: black;">
						<td colspan="3"><input type="submit" id="profileTable"
							style="background-color: rgb(255, 229, 233); color: black; font-size: 15px;" value="확인" /></td>
					</tr>
	...
	<!-- <legend style= "font-family: 'Jua', sans-serif"><h2>zz</h2> </legend> -->
	<br>
	<br>
	<br>
